 <div class="sidebar" data-color="rose" data-background-color="black" data-image="../assets/img/sidebar-1.jpg">
              {{--   <div class="logo"><a href="http://www.creative-tim.com/" class="simple-text logo-mini">
                ...
                <div class="sidebar-wrapper">
                    <div class="user">
                        <div class="photo">
                            <img src="{{ asset('propertyAssets/img/faces/avatar.jpg') }}" />
                        </div>
                        <div class="user-info">
                    ...
                    <ul class="nav">
                      ...
                      {{--   <li class="nav-item ">
                        ...
                        {{-- <li class="nav-item ">
                            <a class="nav-link" href="{{ route('property.list.property') }}">
                            ...
                            <div class="collapse" id="mapsExamples">
                                <ul class="nav">
                                    <li class="nav-item ">
                                        <a class="nav-link" href="{{ route('property.list.property') }}">
                                        <span class="sidebar-mini"> LP </span>
                                        <span class="sidebar-normal"> List Property </span>
                                        </a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" href="{{ route('property.create.property') }}">
