...
Route::group(['prefix' => 'administrator' ,'as' => 'admin.', 'namespace' => 'App\Http\Controllers\admin'], function () {
    ...
    Route::get('delete/faq/question/{id}' ,  ['as' => 'delete.faq.question'  , 'uses' => 'FAQController@deleteFAqQuestion']);
    
     /////////
    // amenities //
    /////////
    Route::get('create/amenities' , ['as' => 'create.amenities' , 'uses' => 'AmenitiesController@index']);
    Route::post('submit/amenities' , ['as' => 'submit.amenities' , 'uses' => 'AmenitiesController@submitAmenities']);
    ...
    Route::get('property/change/status/{id}' , ['as' => 'property.change.status' , 'uses' => 'PropertyController@changeStatus']);

    // } );
});

Route::group(['prefix' => 'property' , 'as' => 'property.' , 'namespace' => 'App\Http\Controllers\property'] , function(){
    ...
    Route::get('list/property' , ['as' => 'list.property' , 'uses' => 'PropertyController@listProperty']);
    Route::post('submit/property' , ['as' => 'submit.property' , 'uses' => 'PropertyController@submitProperty']);

    Route::get('edit/property/{id}' , ['as' => 'edit' , 'uses' => 'PropertyController@editProperty']);
    Route::get('create/property' , ['as' => 'create.property' , 'uses' => 'PropertyController@createProperty']);
    Route::get('delete/other/images/{propertyId}/{index}' , ['as' => 'delete.other.images' , 'uses' => 'PropertyController@deleteOtherImages']);
});